    ...
    return (
        <div className="container w-full mx-auto">
            ...
            >
                ...
                <h1 className="py-5 text-2xl font-bold tracking-tighter text-center">Pokémon Crystal</h1>
                <motion.img src="/images/pokemon.jpg" alt="pokemon" className="w-full mx-auto rounded h-96"
                ...
                <motion.section
                    variants={childrenVariants}
                >
                    <h2 className="py-5 text-2xl font-semibold tracking-tighter">História</h2>
                    <p>
                ...
                <motion.section
                    variants={childrenVariants}
                >
                <h2 className="py-5 text-2xl font-semibold tracking-tighter">Característias</h2>
                    <div>
                        ...
                        Neste jogo também é possível encontrar os lendários da região de Johto: Suicune, Raikou, Entei, Lugia, Ho-oh e celebi! 
                    </div>
                    <div>
